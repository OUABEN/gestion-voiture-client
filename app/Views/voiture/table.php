                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light text-center rounded p-4">
                            ...
                            <div class="chart-container" style=" width: 300px;height: 250px;">
                          <canvas id="voitureChart" style=" width: 100px;height: 100px;"></canvas>
                           </div>
                        </div>
                    </div>
        ...
        var voitureChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#009cff', '#009cff'],
                    borderColor: ['#009cff', '#009cff'],
                    borderWidth: 1
                }]
            },
            options: {
